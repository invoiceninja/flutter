...
class TaskStatusRepository
  ...
  Future<void> refreshAll({required String companyId, bool full = false}) =>
      refreshAllTemplate(
        ...
        maxPages: 100, // ~5k statuses is more than anyone needs
      );
  ...
  /// edit permanently — see [taskStatusDao.clearDirtyById].
  @override
  Future<void> clearLocalDirty({
    required String companyId,
    required String id,
  }) => db.taskStatusDao.clearDirtyById(companyId: companyId, id: id);
