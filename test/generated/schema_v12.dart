...
class NavState extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> confirmActions = GeneratedColumn<int>(
    'confirm_actions',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 1 CHECK (confirm_actions IN (0, 1))',
    defaultValue: const CustomExpression('1'),
  );
  late final GeneratedColumn<int> statusTabs = GeneratedColumn<int>(
    'status_tabs',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 1 CHECK (status_tabs IN (0, 1))',
    defaultValue: const CustomExpression('1'),
  );
  ...
  late final GeneratedColumn<String> tasksView = GeneratedColumn<String>(
    'tasks_view',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  late final GeneratedColumn<int> hideUnverifiedUsers = GeneratedColumn<int>(
    ...
    requiredDuringInsert: false,
    $customConstraints:
        'NOT NULL DEFAULT 0 CHECK (hide_unverified_users IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  late final GeneratedColumn<int> hideEmptyPanels = GeneratedColumn<int>(
    'hide_empty_panels',
    aliasedName,
    true,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NULL CHECK (hide_empty_panels IN (0, 1))',
  );
...
class DeviceContactLinks extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  DeviceContactLinks(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> companyId = GeneratedColumn<String>(
    'company_id',
    aliasedName,
    false,
  ...
  @override
  DeviceContactLinks createAlias(String alias) {
    return DeviceContactLinks(attachedDatabase, alias);
  }
...
class DevicePrefs extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  DevicePrefs(this.attachedDatabase, [this._alias]);
  ...
  @override
  DevicePrefs createAlias(String alias) {
    return DevicePrefs(attachedDatabase, alias);
  }
...
class DatabaseAtV12 extends GeneratedDatabase {
  ...
  late final DeviceContactLinks deviceContactLinks = DeviceContactLinks(this);
  late final DevicePrefs devicePrefs = DevicePrefs(this);
  @override
