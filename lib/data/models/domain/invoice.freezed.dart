...
as List<String>,eInvoice: freezed == eInvoice ? _self.eInvoice : eInvoice // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String number,  String poNumber,  Date? date,  Date? dueDate,  Date? partialDueDate,  InvoiceStatus statusId,  String clientId,  String vendorId,  String projectId,  String designId,  String assignedUserId,  String userId,  String locationId,  String subscriptionId,  String parentInvoiceId,  String recurringId,  Decimal amount,  Decimal balance,  Decimal paidToDate,  Decimal taxAmount,  Decimal discount,  Decimal partial,  bool isAmountDiscount,  Decimal exchangeRate,  String taxName1,  String taxName2,  String taxName3,  Decimal taxRate1,  Decimal taxRate2,  Decimal taxRate3,  bool usesInclusiveTaxes,  Decimal customSurcharge1,  Decimal customSurcharge2,  Decimal customSurcharge3,  Decimal customSurcharge4,  bool customTaxes1,  bool customTaxes2,  bool customTaxes3,  bool customTaxes4,  String publicNotes,  String privateNotes,  String terms,  String footer,  String customValue1,  String customValue2,  String customValue3,  String customValue4,  Date? reminder1Sent,  Date? reminder2Sent,  Date? reminder3Sent,  Date? reminderLastSent,  String reminderSchedule,  String frequencyId,  Date? nextSendDate,  String nextSendDatetime,  Date? lastSentDate,  int remainingCycles,  String dueDateDays,  String autoBill,  bool autoBillEnabled,  bool isLocked,  bool isDeleted,  DateTime updatedAt,  DateTime createdAt,  DateTime? archivedAt,  List<LineItem> lineItems,  List<Invitation> invitations,  List<Document> documents,  List<String> tagIds,  Map<String, dynamic>? eInvoice,  Map<String, dynamic>? backup,  Map<String, dynamic>? taxInfo,  String? modifiedInvoiceId,  String? reason,  List<ScheduleItem> schedule,  bool isDirty)  $default,) {final _that = this;
switch (_that) {
case _Invoice():
return $default(_that.id,_that.number,_that.poNumber,_that.date,_that.dueDate,_that.partialDueDate,_that.statusId,_that.clientId,_that.vendorId,_that.projectId,_that.designId,_that.assignedUserId,_that.userId,_that.locationId,_that.subscriptionId,_that.parentInvoiceId,_that.recurringId,_that.amount,_that.balance,_that.paidToDate,_that.taxAmount,_that.discount,_that.partial,_that.isAmountDiscount,_that.exchangeRate,_that.taxName1,_that.taxName2,_that.taxName3,_that.taxRate1,_that.taxRate2,_that.taxRate3,_that.usesInclusiveTaxes,_that.customSurcharge1,_that.customSurcharge2,_that.customSurcharge3,_that.customSurcharge4,_that.customTaxes1,_that.customTaxes2,_that.customTaxes3,_that.customTaxes4,_that.publicNotes,_that.privateNotes,_that.terms,_that.footer,_that.customValue1,_that.customValue2,_that.customValue3,_that.customValue4,_that.reminder1Sent,_that.reminder2Sent,_that.reminder3Sent,_that.reminderLastSent,_that.reminderSchedule,_that.frequencyId,_that.nextSendDate,_that.nextSendDatetime,_that.lastSentDate,_that.remainingCycles,_that.dueDateDays,_that.autoBill,_that.autoBillEnabled,_that.isLocked,_that.isDeleted,_that.updatedAt,_that.createdAt,_that.archivedAt,_that.lineItems,_that.invitations,_that.documents,_that.tagIds,_that.eInvoice,_that.backup,_that.taxInfo,_that.modifiedInvoiceId,_that.reason,_that.schedule,_that.isDirty);case _:
  throw StateError('Unexpected subclass');
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Invoice&&(identical(other.id, id) || other.id == id)&&(identical(other.number, number) || other.number == number)&&(identical(other.poNumber, poNumber) || other.poNumber == poNumber)&&(identical(other.date, date) || other.date == date)&&(identical(other.dueDate, dueDate) || other.dueDate == dueDate)&&(identical(other.partialDueDate, partialDueDate) || other.partialDueDate == partialDueDate)&&(identical(other.statusId, statusId) || other.statusId == statusId)&&(identical(other.clientId, clientId) || other.clientId == clientId)&&(identical(other.vendorId, vendorId) || other.vendorId == vendorId)&&(identical(other.projectId, projectId) || other.projectId == projectId)&&(identical(other.designId, designId) || other.designId == designId)&&(identical(other.assignedUserId, assignedUserId) || other.assignedUserId == assignedUserId)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.locationId, locationId) || other.locationId == locationId)&&(identical(other.subscriptionId, subscriptionId) || other.subscriptionId == subscriptionId)&&(identical(other.parentInvoiceId, parentInvoiceId) || other.parentInvoiceId == parentInvoiceId)&&(identical(other.recurringId, recurringId) || other.recurringId == recurringId)&&(identical(other.amount, amount) || other.amount == amount)&&(identical(other.balance, balance) || other.balance == balance)&&(identical(other.paidToDate, paidToDate) || other.paidToDate == paidToDate)&&(identical(other.taxAmount, taxAmount) || other.taxAmount == taxAmount)&&(identical(other.discount, discount) || other.discount == discount)&&(identical(other.partial, partial) || other.partial == partial)&&(identical(other.isAmountDiscount, isAmountDiscount) || other.isAmountDiscount == isAmountDiscount)&&(identical(other.exchangeRate, exchangeRate) || other.exchangeRate == exchangeRate)&&(identical(other.taxName1, taxName1) || other.taxName1 == taxName1)&&(identical(other.taxName2, taxName2) || other.taxName2 == taxName2)&&(identical(other.taxName3, taxName3) || other.taxName3 == taxName3)&&(identical(other.taxRate1, taxRate1) || other.taxRate1 == taxRate1)&&(identical(other.taxRate2, taxRate2) || other.taxRate2 == taxRate2)&&(identical(other.taxRate3, taxRate3) || other.taxRate3 == taxRate3)&&(identical(other.usesInclusiveTaxes, usesInclusiveTaxes) || other.usesInclusiveTaxes == usesInclusiveTaxes)&&(identical(other.customSurcharge1, customSurcharge1) || other.customSurcharge1 == customSurcharge1)&&(identical(other.customSurcharge2, customSurcharge2) || other.customSurcharge2 == customSurcharge2)&&(identical(other.customSurcharge3, customSurcharge3) || other.customSurcharge3 == customSurcharge3)&&(identical(other.customSurcharge4, customSurcharge4) || other.customSurcharge4 == customSurcharge4)&&(identical(other.customTaxes1, customTaxes1) || other.customTaxes1 == customTaxes1)&&(identical(other.customTaxes2, customTaxes2) || other.customTaxes2 == customTaxes2)&&(identical(other.customTaxes3, customTaxes3) || other.customTaxes3 == customTaxes3)&&(identical(other.customTaxes4, customTaxes4) || other.customTaxes4 == customTaxes4)&&(identical(other.publicNotes, publicNotes) || other.publicNotes == publicNotes)&&(identical(other.privateNotes, privateNotes) || other.privateNotes == privateNotes)&&(identical(other.terms, terms) || other.terms == terms)&&(identical(other.footer, footer) || other.footer == footer)&&(identical(other.customValue1, customValue1) || other.customValue1 == customValue1)&&(identical(other.customValue2, customValue2) || other.customValue2 == customValue2)&&(identical(other.customValue3, customValue3) || other.customValue3 == customValue3)&&(identical(other.customValue4, customValue4) || other.customValue4 == customValue4)&&(identical(other.reminder1Sent, reminder1Sent) || other.reminder1Sent == reminder1Sent)&&(identical(other.reminder2Sent, reminder2Sent) || other.reminder2Sent == reminder2Sent)&&(identical(other.reminder3Sent, reminder3Sent) || other.reminder3Sent == reminder3Sent)&&(identical(other.reminderLastSent, reminderLastSent) || other.reminderLastSent == reminderLastSent)&&(identical(other.reminderSchedule, reminderSchedule) || other.reminderSchedule == reminderSchedule)&&(identical(other.frequencyId, frequencyId) || other.frequencyId == frequencyId)&&(identical(other.nextSendDate, nextSendDate) || other.nextSendDate == nextSendDate)&&(identical(other.nextSendDatetime, nextSendDatetime) || other.nextSendDatetime == nextSendDatetime)&&(identical(other.lastSentDate, lastSentDate) || other.lastSentDate == lastSentDate)&&(identical(other.remainingCycles, remainingCycles) || other.remainingCycles == remainingCycles)&&(identical(other.dueDateDays, dueDateDays) || other.dueDateDays == dueDateDays)&&(identical(other.autoBill, autoBill) || other.autoBill == autoBill)&&(identical(other.autoBillEnabled, autoBillEnabled) || other.autoBillEnabled == autoBillEnabled)&&(identical(other.isLocked, isLocked) || other.isLocked == isLocked)&&(identical(other.isDeleted, isDeleted) || other.isDeleted == isDeleted)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.archivedAt, archivedAt) || other.archivedAt == archivedAt)&&const DeepCollectionEquality().equals(other._lineItems, _lineItems)&&const DeepCollectionEquality().equals(other._invitations, _invitations)&&const DeepCollectionEquality().equals(other._documents, _documents)&&const DeepCollectionEquality().equals(other._tagIds, _tagIds)&&const DeepCollectionEquality().equals(other._eInvoice, _eInvoice)&&const DeepCollectionEquality().equals(other._backup, _backup)&&const DeepCollectionEquality().equals(other._taxInfo, _taxInfo)&&(identical(other.modifiedInvoiceId, modifiedInvoiceId) || other.modifiedInvoiceId == modifiedInvoiceId)&&(identical(other.reason, reason) || other.reason == reason)&&const DeepCollectionEquality().equals(other._schedule, _schedule)&&(identical(other.isDirty, isDirty) || other.isDirty == isDirty));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,number,poNumber,date,dueDate,partialDueDate,statusId,clientId,vendorId,projectId,designId,assignedUserId,userId,locationId,subscriptionId,parentInvoiceId,recurringId,amount,balance,paidToDate,taxAmount,discount,partial,isAmountDiscount,exchangeRate,taxName1,taxName2,taxName3,taxRate1,taxRate2,taxRate3,usesInclusiveTaxes,customSurcharge1,customSurcharge2,customSurcharge3,customSurcharge4,customTaxes1,customTaxes2,customTaxes3,customTaxes4,publicNotes,privateNotes,terms,footer,customValue1,customValue2,customValue3,customValue4,reminder1Sent,reminder2Sent,reminder3Sent,reminderLastSent,reminderSchedule,frequencyId,nextSendDate,nextSendDatetime,lastSentDate,remainingCycles,dueDateDays,autoBill,autoBillEnabled,isLocked,isDeleted,updatedAt,createdAt,archivedAt,const DeepCollectionEquality().hash(_lineItems),const DeepCollectionEquality().hash(_invitations),const DeepCollectionEquality().hash(_documents),const DeepCollectionEquality().hash(_tagIds),const DeepCollectionEquality().hash(_eInvoice),const DeepCollectionEquality().hash(_backup),const DeepCollectionEquality().hash(_taxInfo),modifiedInvoiceId,reason,const DeepCollectionEquality().hash(_schedule),isDirty]);
...
as List<String>,eInvoice: freezed == eInvoice ? _self._eInvoice : eInvoice // ignore: cast_nullable_to_non_nullable
