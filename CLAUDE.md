...
| Surfacing a record's comments (the Comments card / tab), or how a note renders | § Design system (v2) — the four comment paragraphs · `lib/ui/features/billing_shared/activity/` |
