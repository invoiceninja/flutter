...
class BankTransactionRepository
  ...
  ///
  /// A top-up, not a bundle: bank transactions still load page-by-page through
  ...
  Future<void> applyRefreshDelta({
    required String companyId,
    required List<BankTransactionApi> bundle,
  }) =>
      applyRefreshDeltaTemplate<BankTransactionApi, BankTransactionsCompanion>(
        companyId: companyId,
        bundle: bundle,
        idOf: (a) => a.id,
        ...
        storedUpdatedAt: db.bankTransactionDao.updatedAtAmong,
      );
