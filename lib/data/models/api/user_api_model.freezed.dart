...
@JsonKey(fromJson: _userListData) List<UserApi> get data;
...
@useResult
$Res call({
@JsonKey(fromJson: _userListData) List<UserApi> data
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: _userListData)  List<UserApi> data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserListApi() when $default != null:
return $default(_that.data);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: _userListData)  List<UserApi> data)  $default,) {final _that = this;
switch (_that) {
case _UserListApi():
return $default(_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: _userListData)  List<UserApi> data)?  $default,) {final _that = this;
switch (_that) {
case _UserListApi() when $default != null:
return $default(_that.data);case _:
  return null;
...
class _UserListApi implements UserListApi {
  const _UserListApi({@JsonKey(fromJson: _userListData) final  List<UserApi> data = const <UserApi>[]}): _data = data;
  factory _UserListApi.fromJson(Map<String, dynamic> json) => _$UserListApiFromJson(json);

 final  List<UserApi> _data;
@override@JsonKey(fromJson: _userListData) List<UserApi> get data {
...
@JsonKey(name: 'has_password') bool get hasPassword;@JsonKey(name: 'last_login') int get lastLogin;@JsonKey(name: 'email_verified_at') int get emailVerifiedAt;/// The address this user had *before* their last email change, or `''`.
...
as int,lastConfirmedEmailAddress: null == lastConfirmedEmailAddress ? _self.lastConfirmedEmailAddress : lastConfirmedEmailAddress // ignore: cast_nullable_to_non_nullable
...
class _UserApi implements UserApi {
  const _UserApi({this.id = '', @JsonKey(name: 'first_name') this.firstName = '', @JsonKey(name: 'last_name') this.lastName = '', this.email = '', this.phone = '', this.signature = '', @JsonKey(name: 'language_id') this.languageId = '', @JsonKey(name: 'oauth_provider_id') this.oauthProviderId = '', @JsonKey(name: 'oauth_user_token') this.oauthUserToken = '', @JsonKey(name: 'oauth_user_refresh_token') this.oauthUserRefreshToken = '', @JsonKey(name: 'google_2fa_secret', fromJson: _boolFromJson) this.google2faSecret = false, @JsonKey(name: 'verified_phone_number', fromJson: _boolFromJson) this.verifiedPhoneNumber = false, @JsonKey(name: 'has_password') this.hasPassword = false, @JsonKey(name: 'last_login') this.lastLogin = 0, @JsonKey(name: 'email_verified_at') this.emailVerifiedAt = 0, @JsonKey(name: 'last_confirmed_email_address') this.lastConfirmedEmailAddress = '', @JsonKey(name: 'user_logged_in_notification', fromJson: _boolFromJson) this.userLoggedInNotification = false, @JsonKey(name: 'created_at') this.createdAt = 0, @JsonKey(name: 'updated_at') this.updatedAt = 0, @JsonKey(name: 'archived_at') this.archivedAt = 0, @JsonKey(name: 'is_deleted') this.isDeleted = false, @JsonKey(name: 'custom_value1') this.customValue1 = '', @JsonKey(name: 'custom_value2') this.customValue2 = '', @JsonKey(name: 'custom_value3') this.customValue3 = '', @JsonKey(name: 'custom_value4') this.customValue4 = '', @JsonKey(name: 'company_user') this.companyUser});
...
/// stay in `toJson()` anyway: that is also what produces the Drift
/// payload (`UserRepository._apiToCompanion`).
@override@JsonKey(name: 'last_confirmed_email_address') final  String lastConfirmedEmailAddress;
