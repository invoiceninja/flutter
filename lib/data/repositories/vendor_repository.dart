...
class VendorRepository extends BaseEntityRepository<Vendor, VendorApi>
  ...
  ///
  /// A top-up, not a bundle: vendors still load page-by-page through
  ...
  Future<void> applyRefreshDelta({
  ...
  }) => applyRefreshDeltaTemplate<VendorApi, VendorsCompanion>(
    companyId: companyId,
    bundle: bundle,
    idOf: (a) => a.id,
    ...
    upsert: (byId) =>
        db.vendorDao.upsertAllPreservingDirty(companyId: companyId, byId: byId),
    storedUpdatedAt: db.vendorDao.updatedAtAmong,
  );
