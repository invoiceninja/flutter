...
class ProductRepository extends BaseEntityRepository<Product, ProductApi>
  ...
  ///
  /// A top-up, not a bundle: products still load page-by-page through
  ...
  Future<void> applyRefreshDelta({
    required String companyId,
    required List<ProductApi> bundle,
  }) => applyRefreshDeltaTemplate<ProductApi, ProductsCompanion>(
    companyId: companyId,
    bundle: bundle,
    idOf: (a) => a.id,
    ...
    storedUpdatedAt: db.productDao.updatedAtAmong,
  );
