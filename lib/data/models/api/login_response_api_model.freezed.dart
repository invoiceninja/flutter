...
// so assigned-user ids resolve to display names everywhere — without a
// `GET /users/{id}` round-trip (that endpoint is 412 password-gated).
@override@JsonKey(name: 'users') List<UserApi> get users {
