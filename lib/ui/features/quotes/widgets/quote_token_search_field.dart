...
/// Thin wrapper that wires [TokenSearchField] for the quotes list.
///
...
class QuoteTokenSearchField extends StatefulWidget {
  ...
  @override
  State<QuoteTokenSearchField> createState() => _QuoteTokenSearchFieldState();
}

class _QuoteTokenSearchFieldState extends State<QuoteTokenSearchField> {
  ...
  List<FilterKey> _keysFor(
    ...
    return _keys = buildQuoteFilterKeys(
