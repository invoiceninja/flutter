...
- [`sync.md`](sync.md) — **Sync — the non-obvious rules, with evidence.** The main file still states all 29 rules, one line each — it is the most-cited anchor in the repo.
