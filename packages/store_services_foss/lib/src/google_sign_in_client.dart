...
///
/// [isSupported] is always false, so the login and Connect screens hide their
/// Google buttons and none of the other members is ever reached.
class GoogleSignInClient {
  GoogleSignInClient._();

  static bool isSupported({required String androidServerClientId}) => false;
