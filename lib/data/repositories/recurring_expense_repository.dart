...
class RecurringExpenseRepository
  ...
  /// Lazily hydrate one recurring expense by id when it isn't in the local cache —
  ...
  Future<void> _writeDocuments(
    ...
    String json,
      ...
      (db.update(db.recurringExpenses)..where(
            (e) => e.companyId.equals(companyId) & e.id.equals(entityId),
          ))
          .write(RecurringExpensesCompanion(documents: Value(json)));
}
